...
<<<<<<< Updated upstream
    ...
    <div class="cart-container">
        ...
        <div class="timeline">
            <div class="timeline-step @if (in_array($order->orderStatus, ['Packing', 'Shipped', 'Done', 'Request Refund', 'Rejected', 'Refunded'])) completed @else pending @endif">
                <div class="timeline-icon @if (in_array($order->orderStatus, ['Packing', 'Shipped', 'Done', 'Request Refund', 'Rejected', 'Refunded'])) completed @else pending @endif">
            ...
            <div class="timeline-step @if (in_array($order->orderStatus, ['Shipped', 'Done', 'Request Refund', 'Rejected', 'Refunded'])) completed @else pending @endif">
                <div class="timeline-icon @if (in_array($order->orderStatus, ['Shipped', 'Done', 'Request Refund', 'Rejected', 'Refunded'])) completed @else pending @endif">
            ...
            @if (in_array($order->orderStatus, ['Request Refund', 'Refunded', 'Rejected']))
                @if ($order->orderStatus == 'Refunded')
                    <div class="timeline-step @if (in_array($order->orderStatus, ['Request Refund', 'Refunded', 'Rejected'])) completed @else pending @endif">
                        <div class="timeline-icon @if (in_array($order->orderStatus, ['Request Refund', 'Refunded', 'Rejected'])) completed @else pending @endif">
                ...
                @elseif ($order->orderStatus == 'Request Refund')
                    ...
                    <div class="timeline-step @if (in_array($order->orderStatus, ['Refunded', 'Rejected'])) completed @else pending @endif">
                        <div class="timeline-icon @if (in_array($order->orderStatus, ['Refunded', 'Rejected'])) completed @else pending @endif">
                            {{-- <img src="{{ asset('image/requestRefund.svg') }}" alt="" width="80%"> --}}
                        </div>
                        <div class="timeline-content">
