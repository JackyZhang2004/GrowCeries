    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-between">
          <a class="flex flex-shrink-0 items-center" href="{{ route('admin.home') }}">
        ...
        @auth('admin')
          <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0 pl-1">  
            ...
            <div class="relative ml-4">
              <div>
                <button type="button"
                  ...
                  <span class="username rounded-md px-2 pt-1 text-sm font-medium">Admin</span>
                </button>
              </div>
            ...
            <div
              ...
              <form action="{{ route('admin.logout') }}" method="POST" class="block px-4 py-2 text-sm text-gray-700"
