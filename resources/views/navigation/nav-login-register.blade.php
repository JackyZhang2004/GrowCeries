<nav class="sticky top-0 z-10 w-full navbars">
    ...
    <div class="sm:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="{{ route('home') }}"
                class="block rounded-md px-3 py-2 text-base font-medium" id="{{ Route::is('home') ? 'active' : 'notactive' }}">Home</a>
            <a href="{{ route('order') }}"
                class="hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium" id="{{ Route::is('order') ? 'active' : 'notactive' }}">Order</a>
            <a href="{{ route('about') }}"
                class="hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium" id="{{ Route::is('about') ? 'active' : 'notactive' }}">About</a>
            <a href="{{ route('discover') }}"
                class="hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium" id="{{ Route::is('dicover') ? 'active' : 'notactive' }}">Discover</a>
        </div>
